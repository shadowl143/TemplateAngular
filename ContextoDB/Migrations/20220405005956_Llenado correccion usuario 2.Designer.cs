...
namespace ContextoDB.Migrations
{
    ...
    [Migration("20220405005956_Llenado correccion usuario 2")]
    partial class Llenadocorreccionusuario2
    {
            ...
            modelBuilder.Entity("ContextoDB.Models.Catalogos.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaRegistro = new DateTime(2022, 4, 4, 18, 59, 56, 93, DateTimeKind.Local).AddTicks(6045),
                            Nombre = "Julián",
                            NombreUsuario = "Jlara",
                            Password = "jlara"
                        });
