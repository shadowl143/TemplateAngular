...
namespace ContextoDB.Migrations
{
    ...
    [Migration("20220406023145_Agregar nuevos datos")]
    partial class Agregarnuevosdatos
    {
            ...
            modelBuilder.Entity("ContextoDB.Models.Catalogos.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaRegistro = new DateTime(2022, 4, 5, 20, 31, 44, 731, DateTimeKind.Local).AddTicks(4689),
                            Nombre = "Julián",
                            NombreUsuario = "Jlara",
