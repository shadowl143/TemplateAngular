...
namespace ContextoDB.Migrations
{
    ...
    [Migration("20220821200448_Se llena la tabla rolpagna")]
    partial class Sellenalatablarolpagna
    {
            ...
            modelBuilder.Entity("ContextoDB.Models.Catalogos.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaRegistro = new DateTime(2022, 8, 21, 14, 4, 47, 917, DateTimeKind.Local).AddTicks(3100),
                            Nombre = "Julián",
                            NombreUsuario = "Jlara",
