...
namespace ContextoDB.Migrations
{
    ...
    [Migration("20220406021907_Metodo de cifrado")]
    partial class Metododecifrado
    {
            ...
            modelBuilder.Entity("ContextoDB.Models.Catalogos.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaRegistro = new DateTime(2022, 4, 5, 20, 19, 7, 24, DateTimeKind.Local).AddTicks(6059),
                            Nombre = "Julián",
                            NombreUsuario = "Jlara",
