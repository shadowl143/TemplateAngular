...
namespace ContextoDB.Migrations
{
    ...
    [Migration("20220821203639_Cambio de iconos en la tabla pagina")]
    partial class Cambiodeiconosenlatablapagina
    {
            ...
            modelBuilder.Entity("ContextoDB.Models.Catalogos.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaRegistro = new DateTime(2022, 8, 21, 14, 36, 39, 133, DateTimeKind.Local).AddTicks(9494),
                            Nombre = "Julián",
                            NombreUsuario = "Jlara",
